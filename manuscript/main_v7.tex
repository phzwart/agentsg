...
On 200 perturbed monoclinic frames spanning both sides of a reduction flip, a brute-force reference implementation tested 6960 unimodular matrices per frame at \SI{23}{\milli\second} per frame. The key-first workflow reduced each frame to a cached two-operator coset at \SI{0.07}{\milli\second} per frame, about 330-fold faster per frame (about 180-fold amortised in the present implementation).\chk{z:reindex-bench}
